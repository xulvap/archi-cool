# ACR — lieux restant à classer

1168 lieux relus au moins une fois, sans signal assez fort pour classer avec confiance (pas de mot-clé explicite, architecte non recoupé avec la base MH, pas de figure connue). Une passe complète du jeu a été faite — le reste demanderait des recherches ponctuelles par lieu.

Voir acr/README.md pour la méthode et acr/edge_cases.md pour les cas mis de côté par motif.
